...
**Subagent Delegation Rule:** Never write plain text progress updates for subagents. Always invoke the native `Task` tool so Cursor renders the built-in UI widget.
