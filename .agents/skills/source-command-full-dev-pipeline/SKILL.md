---
name: "source-command-full-dev-pipeline"
description: "Migrated source command `full-dev-pipeline`"
---

# source-command-full-dev-pipeline

Use this skill when the user asks to run the migrated source command `full-dev-pipeline`.
