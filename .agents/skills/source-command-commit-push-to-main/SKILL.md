---
name: "source-command-commit-push-to-main"
description: "Migrated source command `commit-push-to-main`"
---

# source-command-commit-push-to-main

Use this skill when the user asks to run the migrated source command `commit-push-to-main`.
